...
//    }
    ...
    //new bell
//    public boolean updateAppointmentStatus(int appointmentId, String action) throws MessagingException {
//        Appointment appointment = appointmentRepository.findById(appointmentId)
//                .orElseThrow(() -> new IllegalArgumentException("Appointment not found"));
//
...
//        appointmentRepository.save(appointment);
//
//        // Create notification for the patient about the appointment action
//        emailService.createDoctorActionNotification(appointment.getDoctorEmail(), appointment.getPatient().getEmail(), action);
//
//        return true;
//    }
